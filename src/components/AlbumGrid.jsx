...
const AlbumGrid = ({ 
  ...
  return (
    <div className="w-full pt-2">
      <h1 className="border-bottom font-bold">My Portfolio</h1>
      <p className="text-xs mb-5 pt-1">Showcase your accomplishments here</p>
      ...
      {currentAlbum && (
        <>
          <div className="flex flex-col sm:flex-row justify-between items-center mb-2">
            <h2 className="text-md font-bold pb-2">Album title: {currentAlbum.title}</h2>
